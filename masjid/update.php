            ...
            <div class="col-lg-10 col-md-9">
                <div class="main-content">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <div>
                            <h1 class="page-title"><i class="bi bi-building-gear" style="color:#FFD700;"></i> Edit Masjid</h1>
                            <p class="page-subtitle">Perbarui data masjid</p>
                        </div>
                        ...
                        <form method="POST" action="" class="needs-validation" novalidate>
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="nama_masjid" required value="<?php echo htmlspecialchars($data['nama_masjid']); ?>">
                                    <div class="invalid-feedback">Nama masjid wajib diisi</div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Alamat <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="alamat" required value="<?php echo htmlspecialchars($data['alamat']); ?>">
                                    <div class="invalid-feedback">Alamat wajib diisi</div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Kecamatan <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="kecamatan" required value="<?php echo htmlspecialchars($data['kecamatan']); ?>">
                                    <div class="invalid-feedback">Kecamatan wajib diisi</div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Kota <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="kota" required value="<?php echo htmlspecialchars($data['kota']); ?>">
