...
if (isset($_GET['delete']) && isset($_GET['id'])) {
    ...
    if (mysqli_query($koneksi, $query_delete)) {
        echo '<script>
            alert("Data masjid berhasil dihapus!");
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2"><i class="bi bi-building text-warning"></i> Data Masjid</h1>
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <form method="GET" action="" class="row g-3">
                            <div class="col-md-10">
                                <input type="text" class="form-control" name="search" placeholder="🔍 Cari nama masjid, alamat, kecamatan, kota..." value="<?php echo isset($_GET['search']) ? htmlspecialchars($_GET['search']) : ''; ?>">
                            </div>
                            <div class="col-md-2">
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="badge bg-info text-dark"><?php echo htmlspecialchars($row['kecamatan']); ?></span></td>
                                        ...
                                        <td>
                                            ...
                                            <a href="javascript:void(0)" onclick="konfirmasiHapus('read.php?delete=1&id=<?php echo $row['id']; ?>', 'Apakah Anda yakin ingin menghapus masjid &quot;<?php echo htmlspecialchars($row['nama_masjid']); ?>&quot;?')" class="btn btn-sm btn-danger">
                                    ...
                                    <tr>
                                        <td colspan="7" class="text-center py-4">
                                            ...
                                            <p class="text-muted mt-2">Belum ada data masjid</p>
