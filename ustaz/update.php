...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .form-control { border: 2px solid #eef0f5; border-radius: 12px; padding: 10px 14px; font-size: 13px; transition: all 0.3s ease; }
        .form-control:focus { border-color: #FFD700; box-shadow: 0 0 0 4px rgba(255,215,0,0.06); }
            ...
            <div class="col-lg-10 col-md-9">
                <div class="main-content">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <div>
                            <h1 class="page-title"><i class="bi bi-person-gear" style="color:#FFD700;"></i> Edit Ustaz</h1>
                            <p class="page-subtitle">Perbarui data ustaz</p>
                        </div>
                        ...
                        <form method="POST" action="" class="needs-validation" novalidate>
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="nama_ustaz" required value="<?php echo htmlspecialchars($data['nama_ustaz']); ?>">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="bidang_keilmuan" required value="<?php echo htmlspecialchars($data['bidang_keilmuan']); ?>">
                                    <div class="invalid-feedback">Bidang keilmuan wajib diisi</div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Nomor HP</label>
                                    <input type="text" class="form-control" name="no_hp" value="<?php echo htmlspecialchars($data['no_hp']); ?>">
                                </div>
                                <div class="col-md-6 mb-3">
