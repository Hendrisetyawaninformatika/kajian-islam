...
if (isset($_GET['search']) && !empty($_GET['search'])) {
    ...
    $search_condition .= " AND (nama_ustaz LIKE '%$search%' OR bidang_keilmuan LIKE '%$search%' OR alamat LIKE '%$search%' OR no_hp LIKE '%$search%')";
}
...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .badge-keilmuan { background: rgba(16,185,129,0.1); color: #10B981; font-weight: 500; padding: 2px 10px; border-radius: 20px; font-size: 11px; }
            ...
            <div class="col-lg-10 col-md-9">
                <div class="main-content">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <div>
                            <h1 class="page-title"><i class="bi bi-people" style="color:#FFD700;"></i> Data Ustaz</h1>
                            <p class="page-subtitle">Kelola data ustaz</p>
                        </div>
                    ...
                    <div class="filter-card">
                        <form method="GET" action="" class="row g-2">
                            <div class="col-md-10">
                                <input type="text" class="form-control form-control-sm" name="search" placeholder="🔍 Cari nama ustaz, bidang keilmuan, alamat..." value="<?php echo isset($_GET['search']) ? htmlspecialchars($_GET['search']) : ''; ?>">
                            </div>
                            <div class="col-md-2">
                    ...
                    <div class="table-card">
                        <div class="card-header">
                            <h5><i class="bi bi-list"></i> Daftar Ustaz</h5>
                                ...
                                <table class="table table-custom">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="badge-keilmuan"><?php echo htmlspecialchars($row['bidang_keilmuan']); ?></span></td>
                                            <td><?php echo htmlspecialchars($row['no_hp']); ?></td>
                                            <td><?php echo htmlspecialchars($row['alamat']); ?></td>
                                            <td>
                                                <a href="update.php?id=<?php echo $row['id']; ?>" class="btn btn-action btn-edit"><i class="bi bi-pencil"></i></a>
                                                <a href="javascript:void(0)" onclick="konfirmasiHapus('delete.php?id=<?php echo $row['id']; ?>', 'Apakah Anda yakin ingin menghapus ustaz &quot;<?php echo htmlspecialchars($row['nama_ustaz']); ?>&quot;?')" class="btn btn-action btn-delete"><i class="bi bi-trash"></i></a>
                                            </td>
                                        </tr>
                                        <?php endwhile; ?>
                                        <?php else: ?>
