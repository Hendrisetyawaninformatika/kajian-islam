<?php
// =============================================
// FILE: ustaz/create.php
// FUNGSI: Halaman tambah data ustaz
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($nama_ustaz) || empty($bidang_keilmuan)) {
        ...
        $query = "INSERT INTO ustaz (nama_ustaz, bidang_keilmuan, no_hp, alamat) 
                  VALUES ('$nama_ustaz', '$bidang_keilmuan', '$no_hp', '$alamat')";
        
        if (mysqli_query($koneksi, $query)) {
            $message = notifikasi('Data ustaz berhasil ditambahkan!', 'success');
        } else {
...
<head>
    ...
    <title>Tambah Ustaz - Sistem Informasi Jadwal Kajian Islam</title>
...
<body>
            ...
            <div class="col-lg-2 col-md-3">
                <div class="sidebar-premium">
                    ...
                    <ul class="nav-sidebar">
                        ...
                        <li><a href="read.php" class="active"><i class="bi bi-people"></i> Data Ustaz <span class="badge-sidebar"><?php echo $total_ustaz; ?></span></a></li>
            ...
            <div class="col-lg-10 col-md-9">
                <div class="main-content">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <div>
                            <h1 class="page-title"><i class="bi bi-person-plus" style="color:#FFD700;"></i> Tambah Ustaz</h1>
                            <p class="page-subtitle">Tambahkan data ustaz baru</p>
                        </div>
                        ...
                        <form method="POST" action="" class="needs-validation" novalidate>
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Nama Ustaz <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="nama_ustaz" required placeholder="Contoh: Ustaz Dr. Ahmad Fauzi">
                                    <div class="invalid-feedback">Nama ustaz wajib diisi</div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Bidang Keilmuan <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="bidang_keilmuan" required placeholder="Contoh: Tafsir, Hadits, Fiqih">
                                    <div class="invalid-feedback">Bidang keilmuan wajib diisi</div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Nomor HP</label>
                                    <input type="text" class="form-control" name="no_hp" placeholder="Contoh: 08123456789">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Alamat</label>
                                    <input type="text" class="form-control" name="alamat" placeholder="Contoh: Jl. Masjid No. 1, Batang">
                                </div>
                            </div>
    ...
    <nav class="bottom-nav">
        ...
        <a href="read.php" class="active"><i class="bi bi-people"></i><span>Ustaz</span></a>
