        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2"><i class="bi bi-person-plus text-warning"></i> Tambah Ustaz</h1>
                        ...
                        <form method="POST" action="" class="needs-validation" novalidate>
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nama_ustaz" name="nama_ustaz" required placeholder="Contoh: Ustaz Ahmad">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="bidang_keilmuan" name="bidang_keilmuan" required placeholder="Contoh: Tafsir, Hadits, Fiqih">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="alamat" name="alamat" placeholder="Contoh: Jl. Masjid No. 1">
                                </div>
                            </div>
