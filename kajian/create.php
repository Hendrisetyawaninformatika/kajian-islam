            ...
            <div class="col-lg-10 col-md-9">
                <div class="main-content">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <div>
                            <h1 class="page-title"><i class="bi bi-plus-circle" style="color:#FFD700;"></i> Tambah Kajian</h1>
                            <p class="page-subtitle">Tambahkan jadwal kajian baru</p>
                        </div>
                        ...
                        <form method="POST" action="" class="needs-validation" novalidate>
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="judul" required placeholder="Contoh: Kajian Tafsir Al-Quran">
                                    <div class="invalid-feedback">Judul wajib diisi</div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Tema <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="tema" required placeholder="Contoh: Tafsir Surat Al-Fatihah">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <textarea class="form-control" name="deskripsi" rows="4" placeholder="Masukkan deskripsi kajian..."></textarea>
                                </div>
                            </div>
